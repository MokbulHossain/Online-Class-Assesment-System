...
Route::group(['as'=>'teacher.', 'prefix'=>'teacher', 'namespace'=>'Teacher', 'middleware'=>['auth:teacher', 'teacherauth']], function(){
	...
	Route::post('select_student', 'DashboardController@select_student');
	Route::post('attandance/add/{id}', 'DashboardController@attandance_add')->name('attandance.add');
	Route::post('submit_attandance', 'DashboardController@submit_attandance')->name('submit_attandance');

	Route::post('attandance/remove/{id}', 'DashboardController@attandance_remove')->name('attandance.remove');
	Route::get('marks_entry', 'DashboardController@marks_entry')->name('marks_entry');
	Route::post('student_with_marks', 'DashboardController@student_with_marks');
	Route::post('update_marks', 'DashboardController@update_marks');
...
Route::group(['as'=>'student.', 'prefix'=>'student', 'namespace'=>'Student', 'middleware'=>['auth:student']], function(){
	...
	Route::post('marks/student_with_marks', 'CoursesController@student_with_marks');
