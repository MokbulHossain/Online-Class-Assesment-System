...
<!-- teacher menu.......................             -->
                    ...
                    @if(Request::is('teacher*'))
                        ...
                        <li><a href="{{ route('teacher.marks_entry') }}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Marks Entry</span></a></li>
...
<!-- 
                        ...
                        <li><a href="{{route('student.profile.index')}}"><i class="{{Request::is('student/profile')? 'active':''}} icon-user"></i><span class="hidden-tablet"> Profile</span></a></li>
                    @endif
{{-- Admin route.............................--}}
